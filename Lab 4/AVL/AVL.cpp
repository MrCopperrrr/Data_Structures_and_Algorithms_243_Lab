...
//---------------------------------------------------------
Error_code AVL_tree::avl_insert(AVL_node *&sub_root, const int &new_data, bool &taller) {
...
//---------------------------------------------------------
Error_code AVL_tree::avl_remove(AVL_node *&sub_root, const int &old_data, bool &shorter) {
    Error_code result = success;
    if (sub_root == NULL) {
        result = not_present;
        shorter = false;
        ...
        if (sub_root->right == NULL) {
            ...
            AVL_node *parent_pred = sub_root;
            AVL_node *pred = sub_root->left;
            while (pred->right != NULL) {
                parent_pred = pred;
                pred = pred->right;
            }
            sub_root->data = pred->data;
            if (parent_pred == sub_root) {
                result = avl_remove(sub_root->left, pred->data, shorter);
            } else {
                result = avl_remove(parent_pred->right, pred->data, shorter);
            }
            if (shorter == true) {
                switch (sub_root->get_balance()) {
                case equal_height:
...
//---------------------------------------------------------
void AVL_tree::left_balance(AVL_node *&sub_root, bool &changeHeight) {
    AVL_node *&left_tree = sub_root->left;
...
//---------------------------------------------------------
void AVL_tree::right_balance(AVL_node *&sub_root, bool &changeHeight) {
    AVL_node *&right_tree = sub_root->right;
